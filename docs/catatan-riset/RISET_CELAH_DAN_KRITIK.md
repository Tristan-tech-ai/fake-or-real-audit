...
**Basis bukti:** hasil riset literatur yang diberikan **plus** verifikasi langsung ke repo kerja di (jalur lokal, dihapus) (`TEMUAN_GROUND_TRUTH.md`, `HASIL_EKSPERIMEN.md`, `PERBANDINGAN.md`, `VERIFIKASI_RUJUKAN.md`, `audit_aucs.json`, `runs/`)
