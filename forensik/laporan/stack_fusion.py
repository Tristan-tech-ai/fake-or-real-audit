...
from ..models.data import AugmentConfig, FoRDataset, collate, load_manifest, make_splits
...
def fuse():
    ...
    open(os.path.join(HERE, "docs", "hasil", "HASIL_STACKING.md"), "w", encoding="utf-8").write("\n".join(L))
    print("\n-> HASIL_STACKING.md")
