...
fig.tight_layout()
fig.savefig(os.path.join(HERE, "gambar", "generasi_tts.png"), bbox_inches="tight")
plt.close(fig)

open(os.path.join(HERE, "docs", "hasil", "HASIL_GENERASI.md"), "w", encoding="utf-8").write("\n".join(L))
print("\n-> HASIL_GENERASI.md, gambar/generasi_tts.png")
