...
def parse(tag):
    ...
    # Konfigurasi ikut menjadi bagian kunci, lihat catatan di parse() pada
    # make_paper.py mengenai penggabungan konfigurasi yang berbeda.
...
fig.tight_layout()
fig.savefig(os.path.join(HERE, "gambar", "tradeoff.png"), bbox_inches="tight")
plt.close(fig)

open(os.path.join(HERE, "docs", "hasil", "HASIL_TRADEOFF.md"), "w", encoding="utf-8").write("\n".join(L))
print("\n-> HASIL_TRADEOFF.md, gambar/tradeoff.png")
